...
# SP(c,y)
edgeList = [("ASE", "CSMR"), ("ASE", "GPCE"), ("ASE", "ICPC"), ("ASE", "MSR"), ("ASE", "SCAM"), \
		("ASE", "WCRE"), ("CSMR", "SCAM"), ("FASE", "GPCE"), ("FASE", "ICPC"), ("FASE", "SCAM"), \
		("FSE", "GPCE"), ("FSE", "ICPC"), ("FSE", "MSR"), ("FSE", "SCAM"), ("FSE", "WCRE"), \
		("ICSE", "ICSM"), ("ICSE", "MSR"), ("ICSE", "SCAM"), ("ICSE", "WCRE"), ("ICSM", "MSR"), \
		("ICSM", "SCAM"), ("ICSM", "WCRE"), ("ICSE", "ASE"), ("FSE", "CSMR"), ("ICSE", "CSMR"), \
		("ICSM", "CSMR"), ("FSE", "FASE"), ("ICSE", "FASE"), ("ICSE", "FSE"), ("ICSE", "GPCE"), \
		("ICSM", "GPCE"), ("ICSE", "ICPC"), ("ICSM", "ICPC"), ("WCRE", "SCAM")]
...
edgeList = [("ASE", "CSMR"), ("ASE", "ICPC"), ("ASE", "ICSM"), ("ASE", "MSR"), ("ASE", "SCAM"), \
		...
		("ICSE", "WCRE"), ("ICSM", "MSR"), ("ICSM", "SCAM"), ("FSE", "ASE"), ("ICSE", "ASE"), \
		("FASE", "CSMR"), ("FSE", "CSMR"), ("ICSE", "CSMR"), ("ICSE", "FASE"), ("ICSE", "GPCE"), \
		("ICSE", "ICPC"), ("ICSM", "ICPC"), ("WCRE", "SCAM")]
dotPath = os.path.join(imgPath, "tilde_rl.pdf")

# RNC(c,y,1)
edgeList = [("FASE", "ICPC"), ("FASE", "ICSM"), ("FASE", "MSR"), ("FASE", "SCAM"), ("FASE", "WCRE"), \
		("FSE", "ICPC"), ("FSE", "ICSM"), ("FSE", "MSR"), ("FSE", "SCAM"), ("FSE", "WCRE"), ("GPCE", "ICPC"), \
		("GPCE", "ICSM"), ("GPCE", "MSR"), ("GPCE", "SCAM"), ("GPCE", "WCRE"), ("ICSE", "ICSM"), \
		("ICSE", "MSR"), ("ICSE", "SCAM"), ("ICSE", "WCRE"), ("FASE", "ASE"), ("FSE", "ASE"), \
		("GPCE", "ASE"), ("ICSE", "ASE"), ("FASE", "CSMR"), ("FSE", "CSMR"), ("GPCE", "CSMR"), \
		("ICSE", "CSMR"), ("ICSE", "ICPC")]
dotPath = os.path.join(imgPath, "tilde_rnc1.pdf")

# RNA(c,y,4)
edgeList = [("ASE", "ICPC"), ("ASE", "ICSM"), ("ASE", "WCRE"), ("FASE", "ICPC"), ("FASE", "ICSE"), \
		("FASE", "ICSM"), ("FASE", "WCRE")]
dotPath = os.path.join(imgPath, "tilde_rna4.pdf")

# RPNA(c,y,4) - openness
edgeList = [("ASE", "ICPC"), ("ASE", "WCRE"), ("FASE", "ICPC"), ("FASE", "ICSE"), ("FASE", "ICSM"), \
		("FASE", "MSR"), ("FASE", "WCRE"), ("SCAM", "WCRE"), ("SCAM", "ICPC")]
dotPath = os.path.join(imgPath, "tilde_rpna4.pdf")

# RAC(c,y,0) - introversion
edgeList = [("ASE", "FASE"), ("CSMR", "FASE"), ("CSMR", "FSE"), ("CSMR", "GPCE"), ("ICPC", "ICSE"), \
		("ICPC", "ASE"), ("ICSM", "ASE"), ("MSR", "ASE"), ("WCRE", "ASE"), ("ICPC", "CSMR"), \
		("MSR", "CSMR"), ("WCRE", "CSMR"), ("ICPC", "FASE"), ("ICSE", "FASE"), ("ICSM", "FASE"), \
		("MSR", "FASE"), ("SCAM", "FASE"), ("WCRE", "FASE"), ("ICPC", "FSE"), ("ICSM", "FSE"), \
		("MSR", "FSE"), ("SCAM", "FSE"), ("WCRE", "FSE"), ("ICPC", "GPCE"), ("ICSM", "GPCE"), \
		("MSR", "GPCE"), ("SCAM", "GPCE"), ("WCRE", "GPCE"), ("ICSM", "ICSE"), ("MSR", "ICSE"), \
		("SCAM", "ICSE"), ("WCRE", "ICSE")]
